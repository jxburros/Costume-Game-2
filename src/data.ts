...
export const NPCS: NPC[] = [
  ...
  },
  {
    ...
    spriteUrl: '',
    characterParts: PAPER_NOX_PARTS,
    position: { x: 7, y: 7 },
    info: {
...
const NEW_NPC_NYRA: NPC = {
  ...
  characterParts: PAPER_NYRA_PARTS,
  position: { x: 7, y: 2 },
  dialogue: {
